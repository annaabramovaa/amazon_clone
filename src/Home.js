    ...
    <div>
      <div className="home">
        <div className="home_container">
          <img
            src="https://apix-drive.com/media/blogimg/auto/ru/e-commerce.png"
            alt=""
          ...
          <div className="home_row">
            <Product
              id="12321341"
              title=" Bennett™ Mystic Formal Business Briefcase Bag Crossbody Messenger
          ...
          Inch | Handbags with Shoulder Straps (Blue) 6 Months Warranty"
              price={11.96}
              rating={5}
              image="https://m.media-amazon.com/images/I/71mEsHyzSCL._SY355_.jpg"
            />
            <Product
              id="49538094"
